...
pub enum Event {
    ...
    KeyboardTextChar       { keyboard: DeviceID, window: WindowHandle, instant: EventInstant, char: char, repeat_count: u32, },
    KeyboardKeyPressed     { keyboard: DeviceID, window: WindowHandle, instant: EventInstant, key: Key, repeat_count: u32, },
...
impl Event {
    ...
    pub fn instant(&self) -> Option<EventInstant> {
        match *self {
            ...
            Event::KeyboardTextChar       { keyboard: _, window: _, instant, char: _, repeat_count: _, } => Some(instant),
            Event::KeyboardKeyPressed     { keyboard: _, window: _, instant, key: _, repeat_count: _, } => Some(instant),
